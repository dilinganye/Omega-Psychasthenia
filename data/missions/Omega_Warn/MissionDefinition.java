...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.addBriefingItem("提示：你的舰船很小，生存下去即可");

		// Set up the player's fleet.


		api.addToFleet(FleetSide.PLAYER, "IIRT_Omega_Bit_Only", FleetMemberType.SHIP, "字节", true);

		api.addToFleet(FleetSide.PLAYER, "IIRT_Omega_Tangento_Only", FleetMemberType.SHIP, "正切", false);
		api.addToFleet(FleetSide.PLAYER, "IIRT_Omega_Tangento_Only2", FleetMemberType.SHIP, "正切", false);
		api.addToFleet(FleetSide.PLAYER, "IIRT_Omega_Cosinus_Only", FleetMemberType.SHIP, "余弦", false);
		api.addToFleet(FleetSide.PLAYER, "IIRT_Omega_Sinus_Only_4", FleetMemberType.SHIP, "正弦", false);

		api.addToFleet(FleetSide.PLAYER, "IIRT_Omega_Heart_Only", FleetMemberType.SHIP, "心脉", false);


		api.addToFleet(FleetSide.PLAYER, "IIRT_Omega_Bit_Only", FleetMemberType.SHIP, "字节", false);
		api.addToFleet(FleetSide.PLAYER, "IIRT_Omega_Kb_Only", FleetMemberType.SHIP, "千兆", false);
		api.addToFleet(FleetSide.PLAYER, "IIRT_Omega_Kb_Only", FleetMemberType.SHIP, "千兆", false);
		api.addToFleet(FleetSide.PLAYER, "IIRT_Omega_Arrow_Only", FleetMemberType.SHIP, "箭头", false);
		api.addToFleet(FleetSide.PLAYER, "IIRT_Omega_Crack_Only", FleetMemberType.SHIP, "瑕疵", false);


		api.addToFleet(FleetSide.PLAYER, "IIRT_Omega_Cube_Shock", FleetMemberType.SHIP, "魔方", false);
		api.addToFleet(FleetSide.PLAYER, "IIRT_Omega_Cube_Shock_Plus", FleetMemberType.SHIP, "魔方", false);
