...
class KeybindsScript : EveryFrameScript {
    ...
    override fun advance(amount: Float) {
        ...
        val paused =
            Global.getSector().campaignUI.currentCoreTab == CoreUITabId.FLEET || Global.getSector().campaignUI.currentCoreTab == null
    ...
    fun openSettings() {
        if (Keyboard.isKeyDown(Keyboard.KEY_NONE) || Keyboard.isKeyDown(Keyboard.KEY_LCONTROL) || Keyboard.isKeyDown(
                Keyboard.KEY_LMENU
            )
        ) return
