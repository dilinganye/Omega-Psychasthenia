...
class LunaSettingsUISettingsPanel : CustomUIPanelPlugin {
    ...
    fun recreatePanel() {
        ...
        for (data in LunaSettingsLoader.SettingsData) {
            ...
            if (data.fieldType == SettingsType.Header.toString()) {
                ...
                color =
                    Color((color.red * 0.90f).toInt(), (color.green * 0.90f).toInt(), (color.blue * 0.90f).toInt(), 255)

                descriptionElement.addSpacer(5f)
                var description =
                    descriptionElement.addPara("${data.defaultValue}", 0f, color, Misc.getHighlightColor())
                ...
                cardPanel.position!!.setSize(
                    cardPanel.position!!.width,
                    cardPanel.position!!.height + description.position.height
                )
                ...
                var descriptionElement =
                    cardPanel.lunaElement!!.createUIElement(width * 0.6f - 20, requiredSpacing, false)
                descriptionElement.position.inTL(0f, 0f)
                //cardPanel.uiElement.addComponent(descriptionElement)
                cardPanel.lunaElement!!.addUIElement(descriptionElement)
                ...
                cardPanel.position!!.setSize(
                    cardPanel.position!!.width,
                    cardPanel.position!!.height + name.position.height
                )
                ...
                color =
                    Color((color.red * 0.90f).toInt(), (color.green * 0.90f).toInt(), (color.blue * 0.90f).toInt(), 255)
                var description =
                    descriptionElement.addPara(data.fieldDescription.replaceLunaLibValue(), 0f, color, Misc.getHighlightColor())
                ...
                var interactbleElement =
                    cardPanel.lunaElement!!.createUIElement(width * 0.4f - 20, requiredSpacing, false)
                ...
                var createdElement = when (data.fieldType) {
                    SettingsType.Int.toString(), SettingsType.Double.toString(), SettingsType.String.toString() -> createTextFieldCard(
                        data,
                        cardPanel,
                        interactbleElement
                    )
    ...
    fun createTextFieldCard(
        data: LunaSettingsData,
        cardPanel: LunaUIPlaceholder,
        interactbleElement: TooltipMakerAPI
    ): LunaUIBaseElement? {
        //interactbleElement.addPara("Test", 0f)
        ...
        if (data.fieldType == SettingsType.Double.toString()) {
            ...
            var textField = LunaUITextFieldWithSlider(
                value,
                data.minValue.toFloat(),
                data.maxValue.toFloat(),
                200f,
                height,
                data,
                "SettingGroup",
    ...
    fun createButtonCard(
        ...
        var button =
            LunaUIButton(value!!, true, 200f, height, data, "SettingGroup", cardPanel.lunaElement!!, interactbleElement)
    ...
    fun createColorCard(
        ...
        if (cardPanel.position!!.height < height) {
            cardPanel.position!!.setSize(
                cardPanel.position!!.width,
                cardPanel.position!!.height + picker.position!!.height
            )
    ...
    fun createKeybindCard(
        ...
        var button = LunaUIKeybindButton(
            value!!,
            false,
            200f,
            height,
    ...
    fun createRadioCard(
        ...
        var choices = (data.secondaryValue as String).split(",").map { it.trim() } // 没救了，这个数据分类制已经彻底没救了

        var radio = LunaUIRadioButton(
            value!!,
            choices,
            200f,
            0f,
        ...
        for (button in radio.buttons) {
            ...
            if (cardPanel.height < (25 + 5) * radio.buttons.size) {
                ...
                cardPanel.position!!.setSize(
                    cardPanel.position!!.width,
                    cardPanel.position!!.height + button.height + 5
                )
    ...
    fun recreateAboutSection() {
        ...
        var title =
            description.addPara(getString(2), 0f, Misc.getBrightPlayerColor(), Misc.getHighlightColor())
        description.setParaFont(Fonts.ORBITRON_20AABOLD)
        var subtitle = description.addPara(
            getString(3),
            0f,
        ...
        description.addPara(getString(4), 0f, Misc.getBasePlayerColor(), Misc.getHighlightColor())
        ...
        description.addPara(getString(6), 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        description.addPara(getString(7), 0f, Misc.getBasePlayerColor(), Misc.getHighlightColor())

        description.addSpacer(10f)

        description.addPara(getString(8), 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        description.addPara(getString(9), 0f, Misc.getBasePlayerColor(), Misc.getHighlightColor())

        description.addSpacer(10f)

        description.addPara(getString(10), 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        description.addPara(getString(11), 0f, Misc.getBasePlayerColor(), Misc.getHighlightColor())

        description.addSpacer(10f)

        description.addPara(getString(12), 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        description.addPara(getString(13), 0f, Misc.getBasePlayerColor(), Misc.getHighlightColor())

        description.addSpacer(10f)

        description.addPara(getString(14), 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        description.addPara(getString(15), 0f, Misc.getBasePlayerColor(), Misc.getHighlightColor())
        ...
        description.addPara(getString(16), 0f, Misc.getPositiveHighlightColor(), Misc.getPositiveHighlightColor())
        ...
        description.addLunaElement(width - 30, 60f).apply {
            ...
            discordButton.addText("          "+getString(18), Misc.getBasePlayerColor())
            var tooltipText = getString(19)

            discordButton.addTooltip(tooltipText, 400f, TooltipMakerAPI.TooltipLocation.BELOW, getString(19, 1))
            ...
            forumButton.addText(getString(20), Misc.getBasePlayerColor())
            var tooltipText2 = getString(21)

            forumButton.addTooltip(tooltipText2, 400f, TooltipMakerAPI.TooltipLocation.BELOW, getString(21, 1))
    ...
    private fun getString(id : Int) : String {
        val className = "LunaSettingsUISettingsPanel"
    ...
    /**
     * 给 Lunalib 的 True 和 False 的译名换掉。
     */
    private fun String.replaceLunaLibValue(): String {
        return this.replace("\$lunalibTrueValue", Global.getSettings().getString("LunaLib_Core_backend", "LunaUIButton_1")).replace("\$lunalibFalseValue", Global.getSettings().getString("LunaLib_Core_backend", "LunaUIButton_2"))
    }
}