...
GraphicsLib 着色器与游戏自带的抗锯齿功能不完全兼容！您有以下三个选择...

1. 在游戏启动器下方的【选项】中，将抗锯齿设置为【关闭】

2. 在 mods/GraphicsLib 文件夹下，将 GRAPHICS_OPTIONS.ini 中的 "aaCompatMode" 设置为 "true"

3. 在 mods/GraphicsLib 文件夹下，将 GRAPHICS_OPTIONS.ini 中的 "enableShaders" 设置为 "false" 来关闭着色器
                                           """);
                }
            }
        }
