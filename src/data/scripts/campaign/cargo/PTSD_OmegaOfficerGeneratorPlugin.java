...
public class PTSD_OmegaOfficerGeneratorPlugin extends RemnantOfficerGeneratorPlugin {
	...
	public PTSD_OmegaOfficerGeneratorPlugin() {
	}
	...
	public int getHandlingPriority(Object params) {
		...
		if (data.fleet == null || !(data.fleet.getFaction().getId().equals("Omega_Psychasthenia")||data.fleet.getFaction().getId().equals("Omega_Watcher"))) return -1;
