...
public class IIRT_Lab_UnderMine extends BaseIndustry implements RouteFleetSpawner, FleetEventListener {
	...
	//    return super.isFunctional() && market.getFactionId().contentEquals("KRM");
	//}
	...
	public void apply() {
		...
		supply(Commodities.FUEL, size - 2); //提供燃料
		supply(Commodities.ORE, size - 1);  //提供铁矿石
		supply(Commodities.ORGANICS, size - 1);  //提供有机物
		demand(Commodities.HAND_WEAPONS, size - 1); //提供武器(物品栏的)
		demand(Commodities.MARINES, size - 2);  //提供四等人
