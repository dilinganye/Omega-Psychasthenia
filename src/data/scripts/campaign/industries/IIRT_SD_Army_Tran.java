...
public class IIRT_SD_Army_Tran extends BaseIndustry {

	/**
	 * 防御改进的最小和最大倍数
	 */
	public static final float DEFENSE_BONUS_BASE = 4.5f;
	...
	public void apply() {
		...
		//demand(Commodities.CREW, size - 2); //提供船员
		//demand(Commodities.SUPPLIES, size - 1); //提供补给
		supply(Commodities.HAND_WEAPONS, size + 0); //提供武器
		supply(Commodities.HEAVY_MACHINERY, size - 4);  //提供重型机械
		supply(Commodities.SHIPS, size + +1); //提供船只
