...
public class IIRT_OmegaStationFleetManager extends SourceBasedFleetManager {
	...
	public IIRT_OmegaStationFleetManager(SectorEntityToken source, float thresholdLY, int minFleets, int maxFleets, float respawnDelay, int minPts, int maxPts) {
	...
	protected CampaignFleetAPI spawnFleet() {
		...
		IIRT_OmegaSeededFleetManager.initRemnantFleetProperties(random, fleet, false);
	...
	public void reportFleetDespawnedToListener(CampaignFleetAPI fleet, FleetDespawnReason reason, Object param) {
		...
		if (reason == FleetDespawnReason.DESTROYED_BY_BATTLE) {
			...
			if (sid != null && source != null && sid.contentEquals(source.getId())) {
				//if (sid != null && sid.contentEquals(source.getId())) {
				totalLost++;
			}
		}
	}
