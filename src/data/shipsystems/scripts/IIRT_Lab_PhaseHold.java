	...
	public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
		...
		if (stats.getEntity() != null && stats.getEntity() instanceof ShipAPI) {
			...
			if (inte.intervalElapsed()) {
				...
				MagicRender.battlespace(sp2, ship.getLocation(), PTSD_I18nUtil.nv, new Vector2f(dynamicSize, dynamicSize), new Vector2f(1000f, 1000f), 360f, MathUtils.getRandomNumberInRange(-60f, 60f), IIRT_Omega_Color.IIRT_Omega_Lab, true, 0.25f, 0.01f, 4f);
